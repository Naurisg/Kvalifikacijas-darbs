...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.size-filter, .type-filter, .material-filter').forEach(checkbox => {
            checkbox.addEventListener('change', () => filterProducts());
        });

        // Filtrē produktus pēc meklēšanas, cenas, izmēra, tipa un materiāla
        function filterProducts() {
            ...
            const filteredProducts = allProducts.filter(product => {
                ...
                const matchesMaterial = selectedMaterials.length === 0 || 
                                       selectedMaterials.some(material => product.material && product.material.includes(material));
                
                return matchesSearch && matchesPrice && matchesSize && matchesType && matchesMaterial;
            });
        ...
        modalBody.innerHTML = `
            <div class="modal-product-details">
                ...
                <div class="modal-product-info">
                    ...
                    <p><strong>Materiāls:</strong> ${product.material || 'Nav norādīts'}</p>
