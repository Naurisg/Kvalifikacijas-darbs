...
<body>
    <div class="shop-container">
        <aside class="filters-sidebar">
            ...
            <div class="filter-section">
                <h3>Tips</h3>
                <label><input type="checkbox" class="type-filter" value="Būvniecības"> Būvniecības ķiveres</label><br>
                <label><input type="checkbox" class="type-filter" value="Industriālās"> Industriālās ķiveres</label><br>
                <label><input type="checkbox" class="type-filter" value="Alpīnisma"> Alpīnisma ķiveres</label><br>
                <label><input type="checkbox" class="type-filter" value="Elektriķu"> Elektriķu ķiveres</label>
            </div>

            <div class="filter-section">
                <h3>Krāsa</h3>
                <label><input type="checkbox" class="color-filter" value="Balta"> Balta</label><br>
                <label><input type="checkbox" class="color-filter" value="Dzeltena"> Dzeltena</label><br>
                <label><input type="checkbox" class="color-filter" value="Sarkana"> Sarkana</label><br>
                <label><input type="checkbox" class="color-filter" value="Zila"> Zila</label><br>
                <label><input type="checkbox" class="color-filter" value="Oranža"> Oranža</label>
            </div>

            <div class="filter-section">
                <h3>Papildaprīkojums</h3>
                <label><input type="checkbox" class="feature-filter" value="Sejassargs"> Ar sejassargu</label><br>
                <label><input type="checkbox" class="feature-filter" value="Austiņas"> Ar austiņām</label><br>
                <label><input type="checkbox" class="feature-filter" value="Lukturis"> Ar lukturi</label><br>
                <label><input type="checkbox" class="feature-filter" value="Ventilācija"> Ar ventilāciju</label>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.size-filter, .type-filter, .color-filter, .feature-filter').forEach(checkbox => {
        ...
        function filterProducts() {
            ...
            const filteredProducts = allProducts.filter(product => {
                ...
                const matchesColor = selectedColors.length === 0 || 
                                     selectedColors.some(color => product.color && product.color.includes(color));
                const matchesFeature = selectedFeatures.length === 0 || 
                                       selectedFeatures.some(feature => product.features && product.features.includes(feature));
                
                return matchesSearch && matchesPrice && matchesSize && matchesType && matchesColor && matchesFeature;
            });
